...
- **Gestion des tireurs DNS et DSQ** — un statut par tireur (Présent / DNS / DSQ) permet de les exclure proprement du classement (renvoyés en bas de liste, score neutralisé) sans les supprimer de la compétition.
